          ...
          <div class="flex items-center justify-end pr-16 lg:pr-0">
            ...
            >
              <input
                ...
                class="sr-only"
              />
              <span class="block text-navy dark:hidden">
                <svg
                  class="fill-current"
                  width="24"
                  height="24"
              ...
              <span class="hidden text-navy dark:block">
                <svg
                  class="fill-current"
                  width="24"
                  height="24"
            ...
            <div class="hidden sm:flex">
              <a
                href="signin.html"
                class="loginBtn px-[22px] py-2 text-base font-medium text-navy hover:opacity-70"
              >
                Sign In
              </a>
              <a
                href="signup.html"
                class="px-6 py-2 text-base font-medium text-navy duration-300 ease-in-out rounded-md bg-navy/20 signUpBtn hover:bg-[#FF6666] hover:text-white"
              >
                Sign Up
              </a>
            </div>
